...
public class LandBased implements Walkable, Singable, Swimmable, Flyable{
	...
	public void relation(String bird) {
		if (bird.equals("ROOSTER")){
			System.out.println(bird+" and CHICKEN are same Family");
		}
